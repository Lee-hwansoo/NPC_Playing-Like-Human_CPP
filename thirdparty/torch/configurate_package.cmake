...
set(${PROJECT_NAME}_INCLUDE_PATH ${${PROJECT_NAME}_INSTALL_PATH}/include CACHE STRING "Torch include path")
set(${PROJECT_NAME}_LIBRARIES Torch CACHE STRING "Torch library path")

set(CMAKE_VS_PLATFORM_TOOLSET_HOST_ARCHITECTURE "x64" CACHE STRING "VS platform toolset architecture")
set(CMAKE_GENERATOR_TOOLSET "host=x64" CACHE STRING "VS generator toolset")

set(CUDA_TOOLKIT_ROOT_DIR "C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v12.6" CACHE STRING "CUDA Toolkit path")
